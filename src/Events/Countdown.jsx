...
const COUNTDOWN_FROM = "3/21/2024";
...
const ShiftingCountdown = () => {
  ...
  return (<div className="mt-44 mb-44" >
    <div className= "m-4 md:mb-28  text-white text-7xl" style={{ fontFamily: 'Impacted' }}>Countdown to the Event</div>
